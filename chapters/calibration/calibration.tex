...
A correction was applied in the analysis described in \SectionRef{sec:analysis} that switches positive for negative (and visa versa) voltages for the affected HPol antennas. 
