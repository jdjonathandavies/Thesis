...
\begin{figure}[htpb]
  \subfloat[Individual waveforms calibration pulser event]{\includegraphics[width=0.45\textwidth]{chapters/analysis/CSW-Coherent-Waveforms-VPol-CP-Med.pdf}}\hfill
  \subfloat[CSW calibration pulser event]{\includegraphics[width=0.45\textwidth]{chapters/analysis/CSW-CSW-VPol-CP-Med.pdf}}\\
  \subfloat[Individual waveforms noise event]{\includegraphics[width=0.45\textwidth]{chapters/analysis/CSW-Coherent-Waveforms-VPol-Noise-Med.pdf}}\hfill
  \subfloat[CSW noise event]{\includegraphics[width=0.45\textwidth]{chapters/analysis/CSW-CSW-VPol-Noise-Med.pdf}}\\
  \subfloat[Simulated neutrino event]{\includegraphics[width=0.45\textwidth]{chapters/analysis/CSW-Coherent-Waveforms-VPol-Nu-Med.pdf}}\hfill
  \subfloat[Simulated neutrino event]{\includegraphics[width=0.45\textwidth]{chapters/analysis/CSW-CSW-VPol-Nu-Med.pdf}}
...
\begin{figure}[htpb]
  \subfloat[Noise Waveform]{\includegraphics[width=0.43\textwidth]{chapters/analysis/Waveform-VPol-Ant2-Noise-Med.pdf}}\hfill
  \subfloat[Noise Probability Spectrum]{\includegraphics[width=0.43\textwidth]{chapters/analysis/ProdProb-VPol-Noise-Med.pdf}}\\
  \subfloat[CW Contaminated Waveform]{\includegraphics[width=0.43\textwidth]{chapters/analysis/Waveform-VPol-Ant2-WB-Med.pdf}}\hfill
  \subfloat[CW Probability Spectrum]{\includegraphics[width=0.43\textwidth]{chapters/analysis/ProdProb-VPol-WB-Med.pdf}}\\
  \subfloat[Simulated Neutrino Waveform]{\includegraphics[width=0.43\textwidth]{chapters/analysis/Waveform-VPol-Ant2-MC-Med.pdf}}\hfill
  \subfloat[Simulated Neutrino Probability Spectrum]{\includegraphics[width=0.43\textwidth]{chapters/analysis/ProdProb-VPol-MC-Med.pdf}}
...
In \FigureRef{fig:Analysis:Thermal-Cuts:Powherence} we see the powherence value calculated in each polarisation for the thermal data set alongside calibration pulser, simulated neutrino events and the chosen cut value. The relative brightness of the 2011 VPol calibration pulser can be seen clearly in the large values of powherence produced compared with the 2012 HPol calibration pulser. 

The chosen cut value was informed from the distribution of the powherence parameter for minimum bias events, which is shown in \FigureRef{fig:Analysis:Background-Estimation:Thermal-Background}. The cut was placed such that the expected number of thermal noise events passing in the full sample would be approximately $0.1$ events for each polarisation.
...
%  \subfloat[Geometry cuts and infrastructure locations]{\includegraphics[width=\largefigwidth]{chapters/analysis/TBGeometry.pdf}}\\
%  \subfloat[VPol events passing thermal cuts]{\includegraphics[width=\largefigwidth]{chapters/analysis/RecoVPol.pdf}}
...
The motivation and details of each of the cuts used in this analysis have been described in previous sections, a summary is shown in \TableRef{tab:Analysis:Cut-Summary}.
...
Some of these cuts use a combination of parameters derived from the data, \TableRef{tab:Analysis:Variables} summarises how these variables are created.
...
\begin{figure}
  ...
  \caption{VPol events failing the IceCube Laboratory and South Pole geometry cut via their reconstructed azimuth. The geometric cut is indicated by the orange line at $-150$ and by the vertical shaded region between $100^{\circ}$ and $150^{\circ}$ in \FigureRef{fig:Analysis:Anthropogenic-Cuts:Geometry-Cuts:VPol-Reco} (a).}
