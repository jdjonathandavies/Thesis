...
\begin{figure}[htpb]
  ...
  \subfloat[Simulated Neutrino Waveform]{\includegraphics[width=0.49\textwidth]{chapters/analysis/Waveform-VPol-Ant2-MC-Med.pdf}}\hfill
  \subfloat[Simulated Neutrino Probability Spectrum]{\includegraphics[width=0.49\textwidth]{chapters/analysis/ProdProb-VPol-MC-Med.pdf}}
...
\begin{center}
  \begin{tabular}{ p{0.18\textwidth} p{0.38\textwidth} p{0.38\textwidth} }
    ...
    CW - total bins broadband check & lower threshold to check that an excess is broadband & $> 20$ pass\\
