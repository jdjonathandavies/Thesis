...
An example predicted flux is shown in \FigureRef{fig:uhe-app:UHEN:UHEN-Flux} and the implications of various compositions for UHE cosmic rays are shown in \FigureRef{fig:uhe-app:UHEN:UHEN-Flux-Composition-Models}. 
...
%-> GZK affect
%-> BZ neutrinos
%-> UHEN produced at the source

%-> BZ fluxes
%-> Seckel flux expectation 
%-> Waxman Bachal

%-> Unkowns about UHECR can be resolved by measurements of UHEN
%-> void measurement still interesting as it can rule out some models

%UHE Neutrino detection
%-> Very hard as the interaction cross-section is low
%-> The flux is fantastically low as well 
%-> Optical cherenkov as lead to the first neutrinos of extra galactic origin
%-> Difficult to scale up for measurements of GZK neutrinos
%-> Need a new detection technique to get to tera ton scale detectors
%
%Askaryan Effect
