...
Despite the success of Cherenkov light based experiments at detecting energetic neutrinos, the attenuation lengths of optical light in naturally occurring media are such that the technology is prohibitively expensive to scale up to the $\sim 100 \kilo \meter ^3$ necessary to observe UHE neutrinos.
